...
from .rolling_command import CamberAngleANDRollingVelocityCommand, CamberAngleANDRollingAngularVelocityCommand
...
@configclass
class CamberAngleANDRollingAngularVelocityCommandCfg(CommandTermCfg):
    """Configuration for the uniform velocity command generator."""

    class_type: type = CamberAngleANDRollingAngularVelocityCommand
    ...
    class Ranges:
        ...
        #ang_vel_z: tuple[float, float] = MISSING
        #rolling_radius: float = MISSING
        """Robot radius in rolling mode (in m)."""
...
@configclass
class CamberAngleANDRollingVelocityCommandCfg(CommandTermCfg):
    """Configuration for the uniform velocity command generator."""

    class_type: type = CamberAngleANDRollingVelocityCommand
    ...
    class Ranges:
        ...
        #lin_vel_x: tuple[float, float] = MISSING
        rolling_lin_vel: tuple[float, float] = MISSING
        """Linear target velocity command range (in m/s)."""
